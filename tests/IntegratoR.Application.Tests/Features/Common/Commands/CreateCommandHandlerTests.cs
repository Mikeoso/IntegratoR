...
/// <summary>
/// Tests for <see cref="CreateCommandHandler{TEntity}"/>.
/// </summary>
public class CreateCommandHandlerTests
{
    ...
    {
        _sut = new CreateCommandHandler<TestEntity>(_service);
    }

    [Fact]
    public async Task Handle_ValidCommand_DelegatesToServiceAddAsync()
    {
        // Arrange
