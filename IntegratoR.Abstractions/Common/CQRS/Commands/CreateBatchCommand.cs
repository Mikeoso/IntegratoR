...
{
    /// <summary>
    /// Represents a generic command to create a batch of entities.
    /// </summary>
    ...
    public record CreateBatchCommand<TEntity>(IReadOnlyList<TEntity> Entities, BatchOptions? Options = null) : ICommand<Result<BatchOutcome>>
